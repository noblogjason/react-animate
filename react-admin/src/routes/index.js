...
import HjDemo_Js from '../components/animation/HjDemo_Js.jsx';
import HjDemo_Css from '../components/animation/HjDemo_Css.jsx';
import BasicAnimations from '../components/animation/BasicAnimations';
import ExampleAnimations from '../components/animation/ExampleAnimations';
import HjDemo_ReactMotion from '../components/animation/HjDemo_ReactMotion.jsx';
import HjDemo_ReactMotionToDo from '../components/animation/HjDemo_ReactMotionToDo.jsx';
import HjDemo_VelocityReact from '../components/animation/HjDemo_VelocityReact.jsx';
import HjDemo_VelocityReactOutIn from '../components/animation/HjDemo_VelocityReactOutIn.jsx';
    ...
    render() {
        return (
            <Switch>
                ...
                <Route exact path="/app/animation/hjDemo_Js" component={HjDemo_Js} />
                <Route exact path="/app/animation/hjDemo_Css" component={HjDemo_Css} />
                ...
                <Route exact path="/app/animation/hjDemo_ReactMotion" component={HjDemo_ReactMotion} />
                <Route exact path="/app/animation/hjDemo_ReactMotionToDo" component={HjDemo_ReactMotionToDo} />
                <Route exact path="/app/animation/hjDemo_VelocityReact" component={HjDemo_VelocityReact} />
                <Route exact path="/app/animation/hjDemo_VelocityReactOutIn" component={HjDemo_VelocityReactOutIn} />
